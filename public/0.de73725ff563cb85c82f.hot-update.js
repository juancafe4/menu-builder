...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = _wrapComponent('_component2')(_react3.default.createClass({
	  ...
	  showModal: function showModal(item) {
	    ...
	    console.log("editMenu:", this.state.editMenu);
	  },
	  close: function close() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MySmallModal = _wrapComponent("_component")(React.createClass({
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement("input", { type: "text", value: this.state.price, onChange: this.changePrice }),
	            React.createElement("input", { type: "text", value: this.state.type, onChange: this.changeType }),
	            React.createElement("input", { type: "text", value: this.state.picUrl, onChange: this.changePicUrl }),
	            React.createElement(Image, { src: this.state.picUrl, rounded: true, responsive: true })
	          ),
	          React.createElement(
	            Modal.Footer,
	            null,
