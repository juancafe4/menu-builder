	...
	var Home = _wrapComponent('_component2')(_react3.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react3.default.createElement(
	      ...
	      _react3.default.createElement(MySmallModal, { show: this.state.smShow, onHide: this.close, menu: this.state.editMenu })
	    );
	  }
	}));
	  ...
	  render: function render() {
	    ...
	    return _react3.default.createElement(
	      ...
	      _react3.default.createElement(
	        ...
	        _react3.default.createElement('input', { type: 'text', placeholder: price, value: this.state.price, onChange: this.changePrice }),
	        _react3.default.createElement('input', { type: 'text', placeholder: type, value: this.state.type, onChange: this.changeType }),
	        _react3.default.createElement('input', { type: 'text', placeholder: picUrl, value: this.state.picUrl, onChange: this.changePicUrl })
	      ),
	      _react3.default.createElement(
