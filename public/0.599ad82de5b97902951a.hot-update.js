	  ...
	  restaurantValidation: function restaurantValidation(e) {
	    ...
	    fetch(url).then(function (Response) {
	      ...
	      if (newRestaurant.length !== 0) {
	        _this.setState({ restaurantId: newRestaurant[0].id });
	        _reactRouter.browserHistory.push('/home/' + _this.state.restaurantId);
	      } else {
	    ...
	    return _react3.default.createElement(
	      ...
	      _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          ...
	          _react3.default.createElement(NewForm, null)
	        )
	      )
	    );
	  }
