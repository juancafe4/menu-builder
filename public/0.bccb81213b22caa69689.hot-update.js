	    ...
	    var menuItems = this.props.menu.map(function (item) {
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement(_reactBootstrap.Button, { onClick: (_this6.showModal, _this6.setState({ editMenu: item })), className: 'btn btn-info fa fa-pencil-square-o' })
	        ),
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
