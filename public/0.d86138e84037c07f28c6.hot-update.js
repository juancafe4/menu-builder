...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditModal = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(menu) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.name !== '') {
	      ...
	      return _react3.default.createElement(
	        ...
	        { show: this.state.show, onHide: this.onClose, bsSize: 'small', 'aria-labelledby': 'contained-modal-title-sm' },
	      ...
	      return _react3.default.createElement('tr', null);
	    }
	  }
	}));
