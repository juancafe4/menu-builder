	      ...
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          ...
	          _react3.default.createElement(
	            ...
	            _react3.default.createElement(_reactBootstrap.Button, { onClick: this.openAddNew, className: 'btn-success fa fa-plus-square fa-sm' })
	          )
	        ),
	        _react3.default.createElement(Home, { menu: this.state.menu, update: this.updateMenu }),
	        _react3.default.createElement(AddModal, { show: this.state.smShow, onSubmit: this.submit, onHide: this.close, menu: this.state.editMenu })
	      );
