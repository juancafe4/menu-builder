...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditModal = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	    console.log('I have something .., ', nextProps.menu);
	        ...
	        _react3.default.createElement(
	          ...
	          _react3.default.createElement(
	            ...
	            _react3.default.createElement(
	              ...
	              null,
	              _react3.default.createElement('input', { type: 'text', value: this.state.menu.name, onChange: this.changeName }),
	              _react3.default.createElement('input', { type: 'text', value: this.state.menu.price, onChange: this.changePrice }),
	              _react3.default.createElement('input', { type: 'text', value: this.state.menu.type, onChange: this.changeType }),
	              _react3.default.createElement('input', { type: 'text', value: this.state.menu.picUrl, onChange: this.changePicUrl }),
