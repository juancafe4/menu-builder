...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuFetch = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    fetch(url).then(function (Response) {
	      ...
	      var newMenu = data.filter(function (data) {
	        return _this2.props.params.id === data.resId;
	      });
	      _this2.setState({ menu: newMenu });

	      return fetch('/api/restaurant/' + _this2.props.params.id);
	    }).then(function (Response) {
	      return Response.json();
	    }).then(function (data) {
	      ...
	      _this2.setState({ restaurant: newMenu });
	    }).catch(function (err) {
	      console.log(err);
	    });
	  },
	  render: function render() {
	    ...
	    var smClose = function smClose() {
	      return _this3.setState({ addShow: false });
	    };
	...
	var Home = _wrapComponent('_component2')(_react3.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var smClose = function smClose() {
	      return _this5.setState({ smShow: false });
	    };
	    var menuItems = this.props.menu.map(function (item) {
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement(_reactBootstrap.Button, { onClick: _this5.showModal.bind(null, item), className: 'btn btn-info fa fa-pencil-square-o' })
	        ),
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement(_reactBootstrap.Button, { onClick: _this5.deleteMenu, className: 'btn btn-danger fa fa-trash' })
	        )
	      );
	    });
	    return _react3.default.createElement(
