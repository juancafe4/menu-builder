...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddModal = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./AddModal\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var MenuFetch = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  openAddModal: function openAddModal(item) {
	    this.setState({ add: item, addShow: true });
	  },
	  ...
	  render: function render() {
	    ...
	    var smClose = function smClose() {
	      return _this2.setState({ addShow: false });
	    };
	      ...
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          ...
	          _react3.default.createElement(
	            ...
	            _react3.default.createElement(_reactBootstrap.Button, { onClick: this.openAddModal.bind(null, item), className: 'btn-success fa fa-plus-square fa-sm' })
	          )
	        ),
	        _react3.default.createElement(Home, { menu: this.state.menu, update: this.updateMenu }),
	        _react3.default.createElement(_AddModal2.default, { show: this.state.addShow, onSubmit: this.submit, onHide: this.close, add: this.state.addNew })
	      );
	...
	var Home = _wrapComponent('_component2')(_react3.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var smClose = function smClose() {
	      return _this4.setState({ smShow: false });
	    };
	    var menuItems = this.props.menu.map(function (item) {
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement(_reactBootstrap.Button, { onClick: _this4.showModal.bind(null, item), className: 'btn btn-info fa fa-pencil-square-o' })
	        ),
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement(_reactBootstrap.Button, { onClick: _this4.deleteMenu, className: 'btn btn-danger fa fa-trash' })
	        )
	      );
	    });
	    return _react3.default.createElement(
