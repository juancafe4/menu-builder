	    ...
	    var menuItems = this.props.menu.map(function (item) {
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement('button', { className: 'btn btn-info fa fa-pencil-sqaure' })
	        ),
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement('button', { className: 'btn btn-warning fa fa-trash' })
	        )
	      );
	    });
	    return _react3.default.createElement(
