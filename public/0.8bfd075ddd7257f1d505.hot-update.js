...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = _wrapComponent('_component2')(_react3.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var modal = _react3.default.createElement(_EditModal2.default, { show: this.state.smShow, onSubmit: this.submit, onHide: this.close, menu: this.state.editMenu });

	    if (this.state.smShow) return _react3.default.createElement(
