...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuFetch = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  updateMenu: function updateMenu(newItem) {
	    //let newMenu = {this.state.menu}.map()
	  ...
	  render: function render() {
	    if (this.state.menu.length) {
	      return _react3.default.createElement(Home, { menu: this.state.menu, update: this.updateMenu });
	    ...
	    var menuItems = this.props.menu.map(function (item) {
	      return _react3.default.createElement(
	        ...
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement('button', { onClick: _this3.showModal.bind(null, item), className: 'btn btn-info fa fa-pencil-square-o' })
	        ),
	        _react3.default.createElement(
	          'td',
	          { className: 'col-xs-1' },
	          _react3.default.createElement('button', { onClick: _this3.deleteMenu, className: 'btn btn-danger fa fa-trash' })
	        )
	      );
	    });
	    return _react3.default.createElement(
